 ...
 * |------+------+------+------+------+------|   [   |    | CP PST|------+------+------+------+------+------|
 * |  DEL |   Z  |   X  |   C  |   V  |   B  |-------|    |-------|   N  |   M  |   ,  |   .  |   /  |KC_ENT|
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   | LGUI | Alt  | CTL  | /Space  /       \ RAISE\  |LOWER | LEFT | RIGHT|
 *                   |      |      |      |/       /         \      \ |      |      |      |
 *                   `----------------------------'           '------''--------------------'
 */
 ...
 [_QWERTY] = LAYOUT( \
  ...
  TD(TD_SHIFT_CAPS), KC_A,   KC_S,    KC_D,    KC_F,    KC_G,                      KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, \
             KC_DEL, KC_Z,   KC_X,    KC_C,    KC_V,    KC_B,   KC_MS_BTN1,  TD(TD_CO_PA),  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  KC_ENT, \
                          KC_LGUI, KC_LALT, KC_LCTL, KC_SPC,   RAISE,   LOWER, KC_LEFT, KC_RIGHT \
),
/* RAISE
 * ,-----------------------------------------.                    ,-----------------------------------------.
...
[_RAISE] = LAYOUT( \
  ...
  _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                   XXXXXXX, XXXXXXX,   KC_UP,  KC_LBRC, KC_RBRC, KC_BSLS, \
  _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                   XXXXXXX, KC_LEFT, KC_DOWN, KC_RIGHT, XXXXXXX, XXXXXXX, \
  _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_MUTE, XXXXXXX, XXXXXXX, KC_UNDS, KC_PLUS,  KC_LCBR, KC_RCBR, KC_PIPE, \
